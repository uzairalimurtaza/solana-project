...
const PrivacyPolicy = () => {
  return (
    <>
      <PrivacyPolicyStyled>
        <Typography
          sx={{ color: "var(--green-color)", textAlign: "center", py: 5 }}
          variant="h4"
        >
          Privacy Policy
        </Typography>
        <Container
          maxWidth="body"
          sx={{ py: "5", color: "#fff", textAlign: "justify" }}
        >
          ...
          <Typography
            sx={{ color: "var(--green-color)", textAlign: "center", py: 1 }}
            variant="h5"
          >
            Interpretation
          </Typography>
